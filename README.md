...
> **兼容说明**：旧的 JWT 格式密钥 (`VITE_SUPABASE_ANON_KEY`) 仍然可用
...
| [🔧 Supabase 配置](./docs/ai-backend-development-guide/02-SUPABASE-SETUP.md) | 项目创建、MCP + Skills 配置 |
...
| [🌐 部署策略](./docs/ai-backend-development-guide/10-DEPLOYMENT-STRATEGIES.md) | 云端/私有化部署、迁移策略 |
...
graph TB
    ...
    subgraph State["状态管理"]
        E["TanStack Query<br/>服务端状态缓存"]
    end

    subgraph Services["服务层"]
        F["API Services<br/>Supabase 调用"]
    end
